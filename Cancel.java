...
import javax.swing.*;
import java.sql.*;
class Cancel extends Connection1 implements ActionListener,ItemListener
{
		JFrame f;
		JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,imgL;
		...
		Cancel()
        {
				...
				l11.setFont(new Font("",Font.BOLD,12));
