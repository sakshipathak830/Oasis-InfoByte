...
import java.sql.*;
import javax.swing.*;
class Reservation extends Connection1 implements ActionListener,FocusListener
{
		JFrame f;
...
public void actionPerformed(ActionEvent e)
{
		...
		if(e.getSource()==b2)
		{
			try
			{
				...
				ps.setInt(2,x);
				ps.executeUpdate();
				JOptionPane.showMessageDialog(null, "Detail Updated Successfuly \n Please remember your PNR No.");
